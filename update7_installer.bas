...
"""online_warning"":""Obrigado por instalar a atualização 1.4.0 do Maze Maker!" & vbNewLine & vbNewLine & "Por favor, não publique labirintos que contenham bugs ou que sejam impossíveis de concluir. Removeremos labirintos que não seguem essas regras e talvez seja necessário proibir a conta do autor de publicar labirintos na comunidade online do Maze Maker."";"
...
"""collect_time"":""Coletar tempo"";" & vbNewLine & _
"""online_warning_title"":""Comunicado importante da PPTGames"";" & vbNewLine & _
"""online_warning"":""Obrigado por instalar a atualização 1.4.0 do Maze Maker!" & vbNewLine & vbNewLine & "Por favor, não publique labirintos que contenham bugs ou que sejam impossíveis de concluir. Removeremos labirintos que não seguem estas regras e talvez seja necessário proibir a conta do autor de publicar labirintos na comunidade online do Maze Maker."";"
...
With Slide4.Shapes("game_txt_save")
    ...
    .Width = .Height
    .Left = Slide4.Shapes("Retângulo 88").Left - 2 * .Width - 26
End With

With Slide4.Shapes("game_txt_publish")
    .TextFrame.TextRange.Text = ""
    .Width = .Height
    .Left = Slide4.Shapes("Retângulo 88").Left - .Width - 13
End With
...
With Slide4.Shapes.Range(Array("Conexão reta 137", "mazetimeoption", "mazetime", "Gráfico 16", "Retângulo: Cantos Arredondados 73", _
"mazecoloroption", "Agrupar 78", "Retângulo: Cantos Arredondados 76")).Group
    .Left = 600
    .Ungroup
End With

With Slide4.Shapes("Retângulo: Cantos Arredondados 76").Duplicate
    .Name = "goalback"
    .Left = 512
    .Top = Slide4.Shapes("Retângulo: Cantos Arredondados 76").Top
    .Width = 80
End With
...
Slide4.Shapes("Retângulo: Cantos Arredondados 90").Name = "elements_back"
